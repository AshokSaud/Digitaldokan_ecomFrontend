                    ...
                    <div className="space-y-4">
                        <form onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input onChange={(e) => setCategoryName(e.target.value)} type="text" className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2
